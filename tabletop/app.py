...
class TabletopApp(App):
    ...
    def build(self) -> TabletopRoot:
        ...
        root = TabletopRoot(
            session_override=self._session,
            block_override=self._block,
...
def main(*, session: Optional[int] = None, block: Optional[int] = None) -> None:
...
if __name__ == "__main__":  # pragma: no cover - manual execution
    ...
    main(session=args.session, block=args.block)
